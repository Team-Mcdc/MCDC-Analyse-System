...
<head>
    ...
    <style>
        ...
        .status-btns a[href="lendmanagement"] {
            color: blue;
        }
    </style>
</head>
...
<body>
    ...
    <div class="status-btns">
        <a href="lendmanagement" >待审核</a>
        <a href="lended" >已借出</a>
        <a href="completed1" >已结束</a>
    </div>
        ...
        <tbody>
            ...
            <c:forEach var="flow" items="${flowlist}">
                <tr>
                    ...
                    <td>
                        <!-- 添加拒绝流入和归还的操作链接 -->
                        <a href="agreelend?borrowingid=${flow.borrowingid}" title="同意">同意</a>
                        <a href="rejectlend?borrowingid=${flow.borrowingid}" title="拒绝">拒绝</a>
