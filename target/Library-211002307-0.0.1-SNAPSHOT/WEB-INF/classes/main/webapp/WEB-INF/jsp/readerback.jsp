...
<body>
    ...
    <div class="status-btns">
        <a href="readerback" >待审核</a>
        <a href="borrowed" >已审核</a>
        <a href="completedback" >已结束</a>
    </div>
        ...
        <tbody>
            ...
            <c:forEach var="flow" items="${flowlist}">
                <tr>
                    ...
                    <td>
                        <!-- 添加拒绝流入和归还的操作链接 -->
                        <a href="readerrejectborrow?borrowingid=${flow.borrowingid}" title="拒绝流入">取消借阅</a>
